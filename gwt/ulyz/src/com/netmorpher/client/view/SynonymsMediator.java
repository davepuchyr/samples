// $Id: SynonymsMediator.java 97 2010-05-13 17:57:57Z dave $
 ...
 *
 */
public class SynonymsMediator extends Mediator implements IMediator {
   static public final String NAME = "SynonymsMediator";

   private SynonymsProxy _proxySynonyms = null;
   private int _selected = -1;
   
   // widgets
   private CaptionPanel _root = new CaptionPanel( "Synonyms" );
   ...
   public String[] listNotificationInterests() {
      return new String[] {
            ...
            ApplicationFacade.SYNONYMS_UPDATED
      };
   }
   ...
   public void handleNotification( INotification notification ) {
      ...
      if ( notice.equals( ApplicationFacade.SYNONYMS_UPDATED ) ) {
         _bEdit.setVisible( true );

         ArrayList<String> keys = _proxySynonyms.getKeys();
         ...
         for ( String key : keys ) {
            ...
            _table.setText( i, 1, _proxySynonyms.getSynonymsString( key ) );
            ++i;
         }
   ...
   public void initialize() {
      ...
      _proxySynonyms = (SynonymsProxy) facade.retrieveProxy( SynonymsProxy.NAME );
      ...
      _bEdit.addClickHandler( new ClickHandler() {
         public void onClick( ClickEvent event ) {
            String key = _proxySynonyms.getKeys().get( _selected );
            _text.setValue( _proxySynonyms.getSynonymsString( key ) );
      ...
      _bDelete.addClickHandler( new ClickHandler() {
         public void onClick( ClickEvent event ) {
            DatabaseWriteVO vo = _proxySynonyms.getDatabaseWriteVO( _selected, null );
      ...
      _commit.addClickHandler( new ClickHandler() {
         public void onClick( ClickEvent event ) {
            ...
            DatabaseWriteVO vo = _proxySynonyms.getDatabaseWriteVO( _selected, _text.getValue() );
