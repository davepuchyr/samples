// $Id: TemplatesMediator.java 97 2010-05-13 17:57:57Z dave $
 ...
 *
 */
public class TemplatesMediator extends Mediator implements IMediator {
   static public final String NAME = "TemplatesMediator";

   private TemplatesProxy _proxyTemplates = null;
   private int _selected = -1;

   // widgets
   private CaptionPanel _root = new CaptionPanel( "Templates" );
   ...
   public String[] listNotificationInterests() {
      return new String[] {
            ...
            ApplicationFacade.TEMPLATES_UPDATED
      };
   }
   ...
   public void handleNotification( INotification notification ) {
      ...
      if ( notice.equals( ApplicationFacade.TEMPLATES_UPDATED ) ) {
         _bEdit.setVisible( true );

         ArrayList<String> keys = _proxyTemplates.getKeys();
         int i = _table.getRowCount() - keys.size();
         while ( --i >= 0 ) _table.removeRow( 0 );
         
         i = 0;
         
         for ( String key : keys ) _table.setText( i++, 0, key );
   ...
   public void initialize() {
      ...
      _proxyTemplates = (TemplatesProxy) facade.retrieveProxy( TemplatesProxy.NAME );
      ...
      _table.addClickHandler( new ClickHandler() {
         public void onClick( ClickEvent event ) {
            ...
            facade.sendNotification( ApplicationFacade.TEMPLATE_SELECTED );
         }
      } );
      ...
      _bEdit.addClickHandler( new ClickHandler() {
         public void onClick( ClickEvent event ) {
            _text.setValue( _proxyTemplates.getKeys().get( _selected ) );
      ...
      _bDelete.addClickHandler( new ClickHandler() {
         public void onClick( ClickEvent event ) {
            DatabaseWriteVO vo = _proxyTemplates.getDatabaseWriteVO( _selected, null );
      ...
      _commit.addClickHandler( new ClickHandler() {
         public void onClick( ClickEvent event ) {
            ...
            DatabaseWriteVO vo = _proxyTemplates.getDatabaseWriteVO( _selected, _text.getValue() );
