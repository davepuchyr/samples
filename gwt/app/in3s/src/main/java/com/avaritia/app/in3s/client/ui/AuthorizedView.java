...
@Singleton
public class AuthorizedView extends Composite implements com.avaritia.app.in3s.client.presenter.AuthorizedView {
   //final static private Logger LOGGER = Logger.getLogger( UnauthorizedView.class.getName() );

   interface Binder extends UiBinder<Widget, AuthorizedView> {
   }
